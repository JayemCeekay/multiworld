...
public class PlotChunkGenerator extends FlatChunkGenerator {
    ...
    public static final Codec<PlotChunkGenerator> CODEC = RecordCodecBuilder.create((instance) -> instance.group(FlatChunkGeneratorConfig.CODEC.fieldOf("settings").forGetter(FlatChunkGenerator::getConfig)).apply(instance, instance.stable(PlotChunkGenerator::new)));

    public PlotChunkGenerator(FlatChunkGeneratorConfig flatChunkGeneratorConfig) {
